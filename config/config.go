...
func (c *Configuration) Init() {
	...
	c.DatabaseURLName = "whisperAdmin:whisperAdmin123456@tcp(127.0.0.1:3306)/whisper"
}
...
func NewConfiguration() *Configuration {
	return &Configuration{
		...
		DatabaseURLName:   "whisperAdmin:whisperAdmin123456@tcp(127.0.0.1:3306)/whisper",
	}
}
